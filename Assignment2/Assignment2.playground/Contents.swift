...
/*
 They allow you to not specify the name of a certain parameter on invocation
 */
/*:
...
/*
 It is a function which takes 2 Ints and returns something of type T
 */
/*:
